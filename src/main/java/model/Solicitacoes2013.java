...
/**
 * Solicitacoes2013 generated by hbm2java
 */
@Entity
@Table(name = "solicitacoes_2013", catalog = "saude_rec")
public class Solicitacoes2013 implements java.io.Serializable {

	private Solicitacoes2013Id id;

	public Solicitacoes2013() {
	}

	public Solicitacoes2013(Solicitacoes2013Id id) {
		this.id = id;
	}
	...
	public Solicitacoes2013Id getId() {
		return this.id;
	}

	public void setId(Solicitacoes2013Id id) {
		this.id = id;
	}
