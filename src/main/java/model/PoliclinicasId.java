...
/**
 * PoliclinicasId generated by hbm2java
 */
@Embeddable
public class PoliclinicasId implements java.io.Serializable {
	...
	public PoliclinicasId() {
	}

	public PoliclinicasId(Integer rpa, Integer microRegiao, Integer cnes,
	...
	@Column(name = "ESPECIALIDADES", length = 350)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PoliclinicasId))
			return false;
		PoliclinicasId castOther = (PoliclinicasId) other;
