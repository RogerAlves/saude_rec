...
/**
 * FarmaciasDaFamiliaId generated by hbm2java
 */
@Embeddable
public class FarmaciasDaFamiliaId implements java.io.Serializable {
	...
	public FarmaciasDaFamiliaId() {
	}

	public FarmaciasDaFamiliaId(Integer rpa, Integer microRegiao, Integer cnes,
	...
	@Column(name = "LATITUDE", length = 70)
	...
	@Column(name = "LONGITUDE", length = 70)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FarmaciasDaFamiliaId))
			return false;
		FarmaciasDaFamiliaId castOther = (FarmaciasDaFamiliaId) other;
